class LimitTemplatePage():
    def __init__(self, page):
        self.page = page
        self.limit_templates_tab = self.page.get_by_role("tab", name="Limits")
        self.create_button = self.page.get_by_role("button", name="Create", exact=True)
        self.limit_template_name_textbox = self.page.get_by_role("textbox", name="Name")
