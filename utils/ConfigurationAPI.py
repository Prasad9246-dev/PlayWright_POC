...
def get_current_template_id(base_url, table_ip, template_type):
    """
    ...
    table_info = get_table_info(table_ip)
...
def update_template(properties, base_url, table_ip, template_type):
    """
    ...
    base_url = base_url.rstrip('/').replace('/login', '')
    access_token = get_access_token(base_url)
    template_id = get_current_template_id(base_url, table_ip, template_type)
